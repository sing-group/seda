...
public class BedToolsBinariesChecker {

  public static void checkBedToolsBinary(String bedToolsCommand) throws BinaryCheckException {
    checkCommand(bedToolsCommand + " --version", 1);
  }
}
