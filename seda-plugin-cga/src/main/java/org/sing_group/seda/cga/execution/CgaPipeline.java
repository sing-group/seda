...
public class CgaPipeline {
  public static final String SEDA_CGA_KEEPTEMPORARYFILES = "seda.cga.keeptemporaryfiles";
  ...
  public CgaPipelineResults run() throws IOException, InterruptedException {
    this.initWorkingDir();
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    SequencesGroup input = DatatypeFactory.getDefaultDatatypeFactory().newSequencesGroup(new File("/home/hlfernandez/Investigacion/Colaboraciones/IBMC-JorgeVieira/Pipelines/CGA/data/public/genbank.fasta_v6").toPath());
    SequencesGroup reference = DatatypeFactory.getDefaultDatatypeFactory().newSequencesGroup(new File("/home/hlfernandez/Investigacion/Colaboraciones/IBMC-JorgeVieira/Pipelines/CGA/data/public/P_Reference").toPath());

//    SequencesGroup input = SequencesGroup.of("IN", emptyMap(), Sequence.of("IN_1", "", "ACTG"));
//    SequencesGroup reference = SequencesGroup.of("REF", emptyMap(), Sequence.of("REF_1", "", "aaaa"));

    new CgaPipeline(
      new DefaultDockerCgaBinariesExecutor(),
      new CgaPipelineParameters(new File("/tmp/seda-cga"), new CgaCompiPipelineConfiguration(), ""), input, reference
    ).run();
  }
}
