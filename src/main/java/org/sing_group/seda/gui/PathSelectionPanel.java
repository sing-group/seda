...
public class PathSelectionPanel extends JPanel {
	...
	private static final ImageIcon ICON_ARROW_LEFT =
		new ImageIcon(TransformationsConfigurationPanel.class.getResource("image/arrow-left.png"));
	private static final ImageIcon ICON_ARROW_RIGHT =
		new ImageIcon(TransformationsConfigurationPanel.class.getResource("image/arrow-right.png"));
	...
	public PathSelectionPanel() {
		...
		this.listAvailableFiles = new JList<String>(new CustomListModel(
			this.model,
		...
		this.listSelectedFiles = new JList<String>(new CustomListModel(
			this.model,
	...
	private void loadFileList() {
		showFileChooserAndProcess(JFileChooser.FILES_ONLY, false, path -> {
			try {
				Files.lines(path)
	...
	private void loadDirectory() {
		showFileChooserAndProcess(JFileChooser.DIRECTORIES_ONLY, true, directory -> {
			try {
