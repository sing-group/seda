...
public class NcbiBlastSedaGuiPlugin extends AbstractSedaGuiPlugin {
  private NcbiBlastTransformationConfigurationPanel configurationPanel =
    new NcbiBlastTransformationConfigurationPanel();
  ...
  public void saveTransformation(File file) throws IOException {
    new JsonObjectWriter<NcbiBlastTransformationProvider>()
  ...
  public void loadTransformation(File file) throws IOException {
    this.configurationPanel.setTransformationProvider(
      new JsonObjectReader<NcbiBlastTransformationProvider>()
        .read(file, NcbiBlastTransformationProvider.class)
    );
  }
}
