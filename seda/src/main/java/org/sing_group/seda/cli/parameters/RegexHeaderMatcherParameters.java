...
public class RegexHeaderMatcherParameters {
  ...
  public static IntegerDefaultValuedStringConstructedOption OPTION_GROUP =
  ...
  public static FlagOption OPTION_CASE_SENSITIVE =
    new FlagOption(
      PARAM_REGEX_CASE_SENSITIVE_NAME, PARAM_REGEX_CASE_SENSITIVE_SHORT_NAME, PARAM_REGEX_CASE_SENSITIVE_HELP
    );

  public static DefaultValuedStringOption OPTION_HEADER_TARGET =
