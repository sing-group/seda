...
//  private static final String OPTION_INPUT_DIRECTORY_NAME = "input_dir";
	...
	public static final StringOption OPTION_STARTING_CODONS = new StringOption(OPTION_STARTING_CODONS_NAME, "sc",
			"A comma-separated list of codons. Sequences that do not start with any of these codons will be removed.",
			true, true);

	public static final BooleanOption OPTION_REMOVE_STOP_CODONS = new BooleanOption(OPTION_REMOVE_STOP_CODONS_NAME,
	...
	public static final BigDecimalOption OPTION_REMOVE_BY_SIZE = new BigDecimalOption(OPTION_REMOVE_BY_SIZE_NAME, "rbs",
	...
	public static final FileOption OPTION_INPUT_DIRECTORY = new FileOption(OPTION_REMOVE_NUM_OF_SEQUENCES_NAME, "i",
	...
	protected List<Option<?>> createSedaOptions() {
		return asList(OPTION_STARTING_CODONS, OPTION_REMOVE_STOP_CODONS, OPTION_REMOVE_NON_MULTIPLE_OF_3,
