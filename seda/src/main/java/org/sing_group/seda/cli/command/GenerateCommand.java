...
public class GenerateCommand extends SedaCommand {
  ...
  public static final StringOption OPTION_STARTING_CODONS =
    new StringOption(
  ...
  public static final BooleanOption OPTION_REMOVE_STOP_CODONS =
    new BooleanOption(
      OPTION_REMOVE_STOP_CODONS_NAME,
      "rsc", "Removes the stop codon of sequences, if present.", true, false
    );

  public static final BooleanOption OPTION_REMOVE_NON_MULTIPLE_OF_3 =
    new BooleanOption(
      OPTION_REMOVE_NON_MULTIPLE_OF_3_NAME, "rn3",
      "Removes sequences with a length that is not multiple of three.", true, false
    );

  public static final BooleanOption OPTION_REMOVE_IF_INFRAME_STOP_CODONS =
    new BooleanOption(
      OPTION_REMOVE_IF_INFRAME_STOP_CODONS_NAME, "rifsc", "Removes sequences with in-frame stop codons", true,
      false
    );

  public static final BigDecimalDefaultValuedStringConstructedOption OPTION_REMOVE_BY_SIZE =
    new BigDecimalDefaultValuedStringConstructedOption(
      ...
      "A percentage value. Removes sequences with a sequence length that are the percentage "
        ...
        + "be used as reference, but a custom sequence can be used with the option: "
        + OPTION_REFERENCE_SEQUENCE_NAME,
      BigDecimal.valueOf(-1L)
    );

  public static final IntegerDefaultValuedStringConstructedOption OPTION_REFERENCE_SEQUENCE =
    new IntegerDefaultValuedStringConstructedOption(
      OPTION_REFERENCE_SEQUENCE_NAME, "rs", "The index of the reference sequence to be used in the "
        + OPTION_REMOVE_BY_SIZE_NAME + " option when removing by size. " + "First sequence has index 0.",
      0
    );

  public static final IntegerDefaultValuedStringConstructedOption OPTION_REMOVE_NUM_OF_SEQUENCES =
    new IntegerDefaultValuedStringConstructedOption(
      OPTION_REMOVE_NUM_OF_SEQUENCES_NAME, "rns",
      "An integer value. Removes files with less sequences that the value provided.", -1
    );

  public static final FileOption OPTION_INPUT_DIRECTORY =
    new FileOption(
      OPTION_REMOVE_NUM_OF_SEQUENCES_NAME, "i",
      "Input directory.", false, true
    );
  ...
  protected List<Option<?>> createSedaOptions() {
    return asList(
      OPTION_STARTING_CODONS, OPTION_REMOVE_STOP_CODONS, OPTION_REMOVE_NON_MULTIPLE_OF_3,
      OPTION_REMOVE_IF_INFRAME_STOP_CODONS, OPTION_REMOVE_BY_SIZE, OPTION_REFERENCE_SEQUENCE,
