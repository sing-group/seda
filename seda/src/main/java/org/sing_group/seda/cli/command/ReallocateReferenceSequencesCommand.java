...
public class ReallocateReferenceSequencesCommand extends SedaCommand {
  ...
  protected TransformationProvider getTransformation(File parametersFile) throws IOException {
    return new JsonObjectReader<ReallocateReferenceSequencesTransformationProvider>()
      .read(parametersFile, ReallocateReferenceSequencesTransformationProvider.class);
  }
}
