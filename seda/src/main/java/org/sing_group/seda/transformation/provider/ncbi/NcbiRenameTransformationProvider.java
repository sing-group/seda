...
import static org.sing_group.seda.transformation.provider.ncbi.NcbiRenameTransformationChangeType.FILE_DELIMITER;
import static org.sing_group.seda.transformation.provider.ncbi.NcbiRenameTransformationChangeType.FILE_POSITION;
import static org.sing_group.seda.transformation.provider.ncbi.NcbiRenameTransformationChangeType.NCBI_TAXONOMY_DELIMITER;
import static org.sing_group.seda.transformation.provider.ncbi.NcbiRenameTransformationChangeType.NCBI_TAXONOMY_FIELDS;
import static org.sing_group.seda.transformation.provider.ncbi.NcbiRenameTransformationChangeType.REPLACEMENTS_MAP_FILE;
import static org.sing_group.seda.transformation.provider.ncbi.NcbiRenameTransformationChangeType.REPLACEMENT_STRING;
import static org.sing_group.seda.transformation.provider.ncbi.NcbiRenameTransformationChangeType.REPLACE_BLANK_SPACES;
import static org.sing_group.seda.transformation.provider.ncbi.NcbiRenameTransformationChangeType.REPLACE_SPECIAL_CHARACTERS;
import static org.sing_group.seda.transformation.provider.ncbi.NcbiRenameTransformationChangeType.SAVE_REPLACEMENTS_MAP;
import static org.sing_group.seda.transformation.provider.ncbi.NcbiRenameTransformationChangeType.SEQUENCE_ADD_INDEX;
import static org.sing_group.seda.transformation.provider.ncbi.NcbiRenameTransformationChangeType.SEQUENCE_DELIMITER;
import static org.sing_group.seda.transformation.provider.ncbi.NcbiRenameTransformationChangeType.SEQUENCE_INDEX_DELIMITER;
import static org.sing_group.seda.transformation.provider.ncbi.NcbiRenameTransformationChangeType.SEQUENCE_POSITION;
