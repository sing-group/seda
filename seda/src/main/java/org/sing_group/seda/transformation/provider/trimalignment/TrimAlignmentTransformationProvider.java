 ...
 * #L%
 */
package org.sing_group.seda.transformation.provider.trimalignment;
...
import org.sing_group.seda.transformation.sequencesgroup.TrimAlignmentSequencesGroupTransformation;

@XmlRootElement
public class TrimAlignmentTransformationProvider extends AbstractTransformationProvider {
  ...
  public TrimAlignmentTransformationProvider() {}
  ...
  public SequencesGroupDatasetTransformation getTransformation(DatatypeFactory factory) {
    return SequencesGroupDatasetTransformation.concat(
      new ComposedSequencesGroupDatasetTransformation(new TrimAlignmentSequencesGroupTransformation(factory)),
