...
public enum RemoveIsoformsChangeType implements TransformationChangeType {
  MINIMUM_ISOFORM_WORD_LENGTH_CHANGED, ISOFORM_SELECTOR_CHANGED, HEADER_MATCHER_CHANGED, SEQUENCE_HEADERS_JOINER_CHANGED, REMOVED_ISOFORMS_FILES_DIRECTORY_CHANGED
}
