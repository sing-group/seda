 ...
 * #L%
 */
package org.sing_group.seda.transformation.provider.removestops;
...
@XmlRootElement
public class RemoveStopCodonsTransformationProvider extends AbstractTransformationProvider {
  @XmlElement
  ...
  public SequencesGroupDatasetTransformation getTransformation(DatatypeFactory factory) {
    return SequencesGroupDatasetTransformation.concat(
      new ComposedSequencesGroupDatasetTransformation(
        factory, new ComposedSequencesGroupTransformation(factory, new RemoveStopCodonsSequenceTransformation(factory))
      ),
