...
public class SplitSedaGuiPlugin extends AbstractSedaGuiPlugin {
  ...
  public void saveTransformation(File file) throws IOException {
    new JsonObjectWriter<SplitConfigurationTransformationProvider>()
  ...
  public void loadTransformation(File file) throws IOException {
    this.panel.setTransformationProvider(
      new JsonObjectReader<SplitConfigurationTransformationProvider>()
        .read(file, SplitConfigurationTransformationProvider.class)
    );
  }
}
