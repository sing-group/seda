...
public class ReformatFastaSedaGuiPlugin extends AbstractSedaGuiPlugin {
  ...
  public void saveTransformation(File file) throws IOException {
    new JsonObjectWriter<ReformatFastaTransformationProvider>()
  ...
  public void loadTransformation(File file) throws IOException {
    this.panel.setTransformationProvider(
      new JsonObjectReader<ReformatFastaTransformationProvider>()
        .read(file, ReformatFastaTransformationProvider.class)
    );
  }
}
