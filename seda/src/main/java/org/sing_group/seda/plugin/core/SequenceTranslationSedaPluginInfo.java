...
public class SequenceTranslationSedaPluginInfo extends AbstractInfo {
  ...
  public static final String PARAM_FRAME_HELP = "Starting at fixed frame";
  public static final String PARAM_FRAME_HELP_GUI = toHtml(PARAM_FRAME_HELP);

  public static final String PARAM_ALL_FRAME_NAME = "all-frame";
  ...
  public static final String PARAM_ALL_FRAME_HELP = "Considering frames 1, 2 and 3";
  ...
  public static final String PARAM_JOIN_FRAME_HELP =
    "When frames 1, 2 and 3 are considered, this option allows indicating whether translated frames must be considered together or separately.";
  ...
  public static final String PARAM_REVERSE_COMPLEMENT_HELP =
    "Whether reverse complement of sequences must be calculated before translation or not. If not selected, sequences are used as they are introduced.";
  public static final String PARAM_REVERSE_COMPLEMENT_HELP_GUI = toHtml(PARAM_REVERSE_COMPLEMENT_HELP);
  ...
  public static final String PARAM_CODON_TABLE_CUSTOM_HELP =
    "This option allows using a custom codon conversion table. If not selected, the prefedined codon table selected is used.\n"
