...
public class ReformatFastaSedaPluginInfo extends AbstractInfo {
  ...
  public static final String PARAM_REMOVE_LINE_BREAKS_HELP =
    "Whether line breaks in sequences must be removed or not. This option is incompatible with the 'Fragment length' option.";
  public static final String PARAM_REMOVE_LINE_BREAKS_HELP_GUI = PARAM_REMOVE_LINE_BREAKS_HELP;
  ...
  public static final String PARAM_FRAGMENT_LENGHT_HELP =
    "The length of the sequence fragments. This option is incompatible with the 'Remove line breaks' option.";
  public static final String PARAM_FRAGMENT_LENGHT_HELP_GUI = PARAM_FRAGMENT_LENGHT_HELP;
