...
public class FilteringSedaPluginInfo extends AbstractInfo {
  ...
  public static final String PARAM_STARTING_CODON_HELP =
    "Filters sequences so that only those starting with the selected codons are kept. Combinations of 3 characters using: 'A', 'C', 'T', 'G'. "
      + "\n\t\tExample: ATG, CCA, AAA, GCT";
  public static final String PARAM_STARTING_CODON_HELP_GUI = toHtml(PARAM_STARTING_CODON_HELP);

  public static final String PARAM_NON_MULTIPLE_3_NAME = "non-multiple-3";
  public static final String PARAM_NON_MULTIPLE_3_SHORT_NAME = "nm3";
  ...
  public static final String PARAM_NON_MULTIPLE_3_HELP =
    "Filters sequences so that only having a length that is multiple of 3 are kept.";
  public static final String PARAM_NON_MULTIPLE_3_HELP_GUI = toHtml(PARAM_NON_MULTIPLE_3_HELP);

  public static final String PARAM_IN_FRAME_STOP_CODONS_NAME = "in-frame-stop-codons";
  public static final String PARAM_IN_FRAME_STOP_CODONS_SHORT_NAME = "ifsc";
  ...
  public static final String PARAM_SEQUENCE_INDEX_NAME = "sequence-index";
  public static final String PARAM_SEQUENCE_INDEX_SHORT_NAME = "si";
  ...
  public static final String PARAM_SEQUENCE_FILE_NAME = "sequence-file";
  public static final String PARAM_SEQUENCE_FILE_SHORT_NAME = "sf";
