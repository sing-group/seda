...
public class FilteringSedaPluginInfo extends AbstractInfo {
  ...
  public static final String DESCRIPTION = "Filter sequences based on different criteria (e.g. sequence length, non-multiple of three, or in-frame stop codons presence, among others).";
  ...
  public static final String PARAM_STARTING_CODON_HELP = "Filters sequences so that only those starting with the selected codons are kept. "
  ...
  public static final String PARAM_NON_MULTIPLE_3_HELP = "Filters sequences so that only those having a length that is multiple of 3 are kept.";
  ...
  public static final String PARAM_IN_FRAME_STOP_CODONS_HELP = "Filters sequences so that only those without in-frame stop codons are kept.";
  ...
  public static final String PARAM_MINIMUM_SEQUENCES_HELP = "Filters files so that only those with the specified minimum number of sequences are kept.";
  ...
  public static final String PARAM_MAXIMUM_SEQUENCES_HELP = "Filters files so that only those with the specified maximum number of sequences are kept.";
  ...
  public static final String PARAM_REMOVE_SIZE_DIFFERENCE_HELP = "Filters sequences so that only those with the specified difference when compared to the reference sequence are kept.";
  ...
  public static final String PARAM_MAX_SIZE_DIFFERENCE_HELP = "The maximum sequence length difference allowed expressed as a percentage.";
  ...
  public static final String PARAM_SEQUENCE_INDEX_HELP = "The index of the sequence to use as reference to compare others. The first sequence corresponds to index 1. "
  ...
  public static final String PARAM_SEQUENCE_FILE_HELP = "The file containing the sequence to use as reference to compare others. "
