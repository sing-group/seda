...
public class CompareSequencesGroupDatasetSedaGuiPlugin extends AbstractSedaGuiPlugin {
  ...
  public CompareSequencesGroupDatasetSedaGuiPlugin() {
    this.panel = new CompareSequencesGroupDatasetConfigurationPanel();
  }
  ...
  public void saveTransformation(File file) throws IOException {
    new JsonObjectWriter<CompareSequencesGroupDatasetTransformationProvider>()
  ...
  public void loadTransformation(File file) throws IOException {
    this.panel.setTransformationProvider(
      new JsonObjectReader<CompareSequencesGroupDatasetTransformationProvider>()
        .read(file, CompareSequencesGroupDatasetTransformationProvider.class)
    );
  }
}
