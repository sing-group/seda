...
public class ConcatenateSequencesSedaGuiPlugin extends AbstractSedaGuiPlugin {
  ...
  public void saveTransformation(File file) throws IOException {
    new JsonObjectWriter<ConcatenateSequencesTransformationProvider>()
  ...
  public void loadTransformation(File file) throws IOException {
    this.panel.setTransformationProvider(
      new JsonObjectReader<ConcatenateSequencesTransformationProvider>()
        .read(file, ConcatenateSequencesTransformationProvider.class)
    );
  }
}
