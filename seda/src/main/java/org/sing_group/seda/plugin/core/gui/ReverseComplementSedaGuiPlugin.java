...
public class ReverseComplementSedaGuiPlugin extends AbstractSedaGuiPlugin {
  ...
  public ReverseComplementSedaGuiPlugin() {
    this.panel = new ReverseComplementTransformationConfigurationPanel();
  }
  ...
  public void saveTransformation(File file) throws IOException {
    new JsonObjectWriter<ReverseComplementTransformationProvider>()
  ...
  public void loadTransformation(File file) throws IOException {
    this.panel.setTransformationProvider(
      new JsonObjectReader<ReverseComplementTransformationProvider>()
        .read(file, ReverseComplementTransformationProvider.class)
    );
  }
}
