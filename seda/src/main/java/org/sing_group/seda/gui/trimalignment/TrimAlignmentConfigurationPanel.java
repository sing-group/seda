 ...
 * #L%
 */
package org.sing_group.seda.gui.trimalignment;
...
public class TrimAlignmentConfigurationPanel extends JPanel {
  private static final long serialVersionUID = 1L;

  private TrimAlignmentTransformationProvider transformationProvider;
  private ReformatFastaConfigurationPanel reformatPanel;

  public TrimAlignmentConfigurationPanel() {
    this.init();
    this.transformationProvider = new TrimAlignmentTransformationProvider();
  ...
  public TrimAlignmentTransformationProvider getTransformationProvider() {
    return this.transformationProvider;
  }

  public void setTransformationProvider(TrimAlignmentTransformationProvider transformationProvider) {
