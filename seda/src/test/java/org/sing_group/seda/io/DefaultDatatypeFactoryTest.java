...
public class DefaultDatatypeFactoryTest {
  ...
  public void loadFileWithLinuxLineBreaks() {
    SequencesGroup group = new DefaultDatatypeFactory().newSequencesGroup(linuxLineBreaksPath);
    assertTrue(group.getProperties().isEmpty());
  }

  @Test
  public void loadFileWithWindowsLineBreaks() {
    SequencesGroup group = new DefaultDatatypeFactory().newSequencesGroup(windowsLineBreaksPath);
