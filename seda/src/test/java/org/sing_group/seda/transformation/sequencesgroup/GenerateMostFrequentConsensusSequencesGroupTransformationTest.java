...
public class GenerateMostFrequentConsensusSequencesGroupTransformationTest {
  ...
  public GenerateMostFrequentConsensusSequencesGroupTransformationTest(
  ...
  public void test() {
    SequencesGroup result =
      new GenerateConsensusSequencesGroupTransformation(
        sequenceType, ConsensusBaseStrategy.MOST_FREQUENT, minimumPresence, verbose
      ).transform(input);
