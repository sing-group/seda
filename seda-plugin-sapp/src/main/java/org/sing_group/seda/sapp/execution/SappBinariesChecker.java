...
public class SappBinariesChecker {

  public static void checkJar(String sappCommand) throws BinaryCheckException {
    checkCommand(sappCommand + " -h", Arrays.asList("Usage: <main class> [options]"));
  }
}
