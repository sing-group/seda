...
public class PfamScanTransformationConfigurationPanelTest {

  public static void main(String[] args) {
    VisualizationUtils.showComponent(getPfamScanTransformationConfigurationPanel());
  }

  private static Component getPfamScanTransformationConfigurationPanel() {
    PfamScanTransformationConfigurationPanel panel = new PfamScanTransformationConfigurationPanel();
