# -*- coding: utf-8 -*-
#
# SEDA documentation build configuration file, created by
...
project = u'SEDA'
copyright = u'2017-2020, Jorge Vieira, Cristina Vieira, Noé Vázquez, Miguel Reboiro-Jato and Hugo López-Fernández'
...
man_pages = [
    (master_doc, 'seda', u'SEDA Documentation',
     [author], 1)
]
